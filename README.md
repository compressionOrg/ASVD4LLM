...
CUDA_VISIBLE_DEVICES='3' python asvd.py --model_id="Enoch/llama-7b-hf" --act_aware --alpha 0.5 --n_calib_samples 32 --scaling_method abs_mean --param_ratio_target 0.2 --use_cache
